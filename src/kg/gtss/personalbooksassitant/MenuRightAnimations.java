...
public class MenuRightAnimations {
	static String TAG = "MenuRightAnimations";
...
/*		Log.v(TAG, "MenuRightAnimations xOffset:" + xOffset + ",yOffset:"
				+ yOffset);*/
	}
	...
	public static void startAnimationsIn(ViewGroup viewgroup, int durationMillis) {
		...
		for (int i = 0; i < viewgroup.getChildCount(); i++) {
			...
			inoutimagebutton.setClickable(true);//enable clickable
		}
	}

	/**
	 * hide servral buttons
	 * */
		...
		for (int i = 0; i < viewgroup.getChildCount(); i++) {
			...
			animation.setAnimationListener(new Animation.AnimationListener() {
				...
				public void onAnimationEnd(Animation arg0) {
					...
					inoutimagebutton.setClickable(false);//disable clickable
				}
			});
			inoutimagebutton.startAnimation(animation);
		}
